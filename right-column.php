<div class="right-column">
	...
	<div class="slidemenu-control"><img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/images/P_222222.svg') ?>" /></div>
	
	
	<ul class="cart_list product_list_widget slidemenu-menu <?php echo $args['list_class']; ?>">
